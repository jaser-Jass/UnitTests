...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        // Проверка метода calculatingDiscount, который принимает сумму покупки и процент скидки и возвращает сумму с учетом скидки:


        Assertions.assertThatThrownBy(() -> calculatingDiscount(70, -1))
                .isInstanceOf(IllegalArgumentException.class)                      // Проверка недопустимой скидки
                .hasMessageContaining("Процент скидки должен быть между 0 и 100");


        assert 90 == calculatingDiscount(100, 10);   // Проверка обычной скидки
        assert 50 == calculatingDiscount(50, 10);    // Проверка отсутствия скидки
        assert 40 == calculatingDiscount(80, 50);    // Проверка половины цены
